...
class Addblog extends Component {
  ...
  async componentWillMount() {
    if (this.props.location.state) {
      this.setState({
        _id: this.props.location.state ? this.props.location.state.blog : "",
        title: this.props.selectedblog[0]["title"]
          ? this.props.selectedblog[0]["title"]
          : "",
        content: this.props.selectedblog[0]["content"]
          ? this.props.selectedblog[0]["content"]
          : ""
      });
      this.previewImage = this.props.selectedblog[0]["path"]
        ? "../files/" + this.props.selectedblog[0]["path"].substr(13)
  ...
  componentWillReceiveProps(props) {
    // if (props.location.pathname === "/addblog") {
    //   this.setState({
    //     _id: "",
    //     title: "",
    //     content: ""
  ...
  render() {
    if (this.props.location.pathname === "/addblog") {
      var title = this.refs.title ? this.refs.title.value : "";
      var content = this.refs.body ? this.refs.body.value : "";
    }
